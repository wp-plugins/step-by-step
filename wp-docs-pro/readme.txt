=== wpDocs ===
Contributors: kmb40
Donate link: http://www.kylembrown.com/wp-docs
...
Display your data wp-docs style with images and display them on your post or pages in minutes with ease. Keep the standard WYSIWYG content separate from your step-by-step instructions for easy editing. 

###Step by Step Pro Features###
...
= Usage =
[For complete usage instructions visit the help page at kylembrown.com/step-by-step](http://kylembrown.com/wp-docs?utm_source=wordpress_org&utm_medium=link&utm_campaign=wp-docs)
...
[Visit the complete FAQ at kylembrown.com/step-by-step](http://kylembrown.com/wp-docs?utm_source=wordpress_org&utm_medium=link&utm_campaign=wp-docs) for additional help and troubleshooting tips.
...
= 0.1.5.1 =
Corrected update button issue erasing text from steps.

= 0.1.5 =
Creates a standard theme independent template 
Changed slug to "docs"

= 0.1.4.5 =
Corrected missing quick tag in editor for new steps

= 0.1.4.3 =
Table of Contents button styling
Corrected issue after a new step has been added to a new OR existing guide, the WYSIWYG editor, creates unwanted menu items such as "File", "Edit", etc.
Corrected missing remove image link for new steps.
Added update button at guide level

= 0.1.4 =
Image size settings implemented (Note: does not apply to guides created using shortcodes)
Removed preview messaging making guides useable in in menus without short codes
Added button to the table of contents

= 0.1.3.1 =
Table of contents instructions.
Removed Preview messaging

= 0.1.3 =
MultiSite broken image fix
Guides included in WP Native Nav Menu editor upon plugin activation.

= 0.1.2 =
WYSIWYG Editor implemented

= 0.1.1 =
Implemented Media upload in place of image upload to provide size options
